...
public class ConfigurableReconnectModVariables {
	...
	public static class WorldVariables extends SavedData {
		public static final SavedDataType<WorldVariables> TYPE = new SavedDataType<>(Identifier.parse("configurable_reconnect:worldvars"), WorldVariables::new, CompoundTag.CODEC.xmap(tag -> {
	...
	public static class MapVariables extends SavedData {
		public static final SavedDataType<MapVariables> TYPE = new SavedDataType<>(Identifier.parse("configurable_reconnect:mapvars"), MapVariables::new, CompoundTag.CODEC.xmap(tag -> {
			MapVariables instance = new MapVariables();
			instance.read(tag);
			return instance;
		}, instance -> instance.save(new CompoundTag())), null);
		boolean _syncDirty = false;
		public double reconnect_delay = 2.0;

		public void read(CompoundTag nbt) {
			reconnect_delay = nbt.getDoubleOr("reconnect_delay", 0);
		}

		public CompoundTag save(CompoundTag nbt) {
			nbt.putDouble("reconnect_delay", reconnect_delay);
			return nbt;
		}
	...
	public record SavedDataSyncMessage(int dataType, SavedData data) implements CustomPacketPayload {
		public static final Type<SavedDataSyncMessage> TYPE = new Type<>(Identifier.fromNamespaceAndPath(ConfigurableReconnectMod.MODID, "saved_data_sync"));
